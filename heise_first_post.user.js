...
function firstPost() {
    ...
    style.innerHTML = '.hfp_container { position: absolute; z-index: 1; padding: 10px; background: white; box-shadow: 3px 3px 15px rgba(0,0,0,0.5); overflow: hidden; display: none; white-space: normal; } .posting_element:hover .hfp_container { display: block; }';
